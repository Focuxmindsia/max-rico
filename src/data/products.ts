...
export const products: Product[] = [
  ...
  {
    id: "10",
    name: "Chorizo Pequeño Santarrosano x10 und",
    slug: "chorizo-santarosano-pack-10",
    category: "Chorizos",
    description: "🧊 CONGELADO · Auténtico chorizo colombiano santarrosano de 7,5 cm. Pack de 10 unidades. Sabor tradicional ahumado, perfecto para asar a la parrilla.",
  ...
  {
    id: "11",
    name: "Chorizo XL Santarrosano x5 und",
    slug: "chorizo-xl-pack-5",
    category: "Chorizos",
    description: "🧊 CONGELADO · Chorizo colombiano santarrosano tamaño XL de 22 cm. Pack de 5 unidades. Ideal para asados y parrilladas.",
    ingredients: "Carne de cerdo, especias naturales, ajo, cebolla, comino, sal, tripa natural.",
  ...
  {
    id: "31",
    name: "1 Chorizo XL Santarrosano a la parrilla (complemento para cualquier combo fritos)",
    slug: "extra-chorizo-xl",
    category: "Combos",
    description: "🔥 LISTO PARA CONSUMIR · Chorizo XL santarrosano a la parrilla, ya asado y listo para disfrutar. Complemento perfecto para cualquiera de nuestros combos fritos.",
    ingredients: "Carne de cerdo, especias naturales, ajo, cebolla, comino, sal, tripa natural.",
  ...
  {
    id: "40",
    name: "Tarrina Ají picante a base de tomate picado",
    slug: "tarrina-aji-picante-tomate",
    category: "Combos",
    description: "🌶️ LISTO PARA CONSUMIR · Tarrina de ají picante a base de tomate picado, cilantro y especias. Sabor fresco e intenso, perfecto para acompañar empanadas y chorizos.",
    ingredients: "Tomate, cilantro, cebolla, ají, ajo, vinagre, aceite, sal.",
  ...
  {
    id: "41",
    name: "Tarrina Salsa de perejil",
    slug: "tarrina-salsa-perejil",
    category: "Combos",
    description: "🌿 LISTO PARA CONSUMIR · Tarrina de salsa de perejil fresco con aceite de oliva, ajo y un toque cítrico. Ideal para empanadas, arepas y chorizos.",
    ingredients: "Perejil fresco, aceite de oliva, ajo, vinagre, sal, limón.",
    preparation: "Listo para servir. Conservar refrigerado tras abrir.",
    conservation: "Refrigerado 2-3 días una vez abierto.",
    price: 0.99,
    memberPrice: 0.99,
  ...
  },
  {
    ...
    category: "Combos",
    description: "🔥 LISTO PARA CONSUMIR · Tarrina de salsa picante cremosa de la casa. Receta secreta, sabor único e intenso para los amantes del picante suave.",
    ingredients: "Aceite vegetal, tomate, ají, huevo pasteurizado, especias, sal, vinagre.",
    preparation: "Listo para servir. Conservar refrigerado tras abrir.",
    conservation: "Refrigerado 2-3 días una vez abierto.",
    price: 0.99,
    memberPrice: 0.99,
