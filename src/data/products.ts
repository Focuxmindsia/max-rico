...
export const products: Product[] = [
  ...
  // === EMPANADAS GRANDES POLLO ===
  {
    ...
    ingredients: "Harina de maíz, pollo mechado, patata cocida, cebolla, ajo, comino, sal, pimienta, aceite vegetal.",
    preparation: " Freír en aceite a 180°C por 12 min, aproximadamente",
    conservation: "Conservar congelado a -18°C. No recongelar una vez descongelado.",
    price: 16.99,
    originalPrice: 17.90,
    memberPrice: 16.49,
  ...
  // === EMPANADAS COCTELERAS ===
  {
    ...
    ingredients: "Harina de maíz, pollo, patata cocida, cebolla, ajo, comino, sal, pimienta, aceite vegetal.",
  ...
  },
  {
    ...
    ingredients: "Champús: maíz, lulo, piña, panela, canela, hojas de naranjo agrio. Empanadas: harina de maíz, carne de ternera, papa, cebolla, ajo, comino, sal. Chorizo: carne de cerdo, especias naturales, ajo, comino, sal.",
