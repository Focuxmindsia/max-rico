...
export const products: Product[] = [
  // === EMPANADAS GRANDES CONGELADAS (1,80€/u coste, 4,50€/u público, 3€/u negocio) ===
  {
    id: "1",
    name: "Empanadas Colombianas Grandes - Pack 10",
    slug: "empanadas-grandes-pack-10",
    category: "Empanadas",
    description: "Deliciosas empanadas colombianas grandes rellenas de carne mechada, papa y especias tradicionales. Masa crujiente por fuera, jugosas por dentro. Formato congelado.",
  ...
  {
    id: "2",
    name: "Empanadas Colombianas Grandes - Pack 20",
    slug: "empanadas-grandes-pack-20",
    category: "Empanadas",
    description: "El pack familiar de nuestras famosas empanadas colombianas grandes. Perfectas para reuniones y celebraciones. Formato congelado.",
    ingredients: "Harina de maíz, carne de res, papa, cebolla, ajo, comino, sal, pimienta, aceite vegetal.",
    preparation: "Horno: 200°C por 15 min. Air fryer: 180°C por 12 min. Freír: aceite a 180°C por 5 min.",
  ...
  {
    id: "3",
    name: "Empanadas Colombianas Grandes - Pack 40",
    slug: "empanadas-grandes-pack-40",
    category: "Empanadas",
    description: "El mega pack para los verdaderos fans. Ahorra más con el formato más grande. Ideal para eventos y negocio. Formato congelado.",
    ingredients: "Harina de maíz, carne de res, papa, cebolla, ajo, comino, sal, pimienta, aceite vegetal.",
    preparation: "Horno: 200°C por 15 min. Air fryer: 180°C por 12 min. Freír: aceite a 180°C por 5 min.",
    conservation: "Conservar congelado a -18°C. No recongelar una vez descongelado.",
    price: 159.99,
