...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "Arepas",
    description: "🧊 CONGELADA · Arepa de chócolo (hecha con maíz tierno molido) con queso latino, de sabor suave y un toque dulcecito, ideal para desayuno o merienda.\n Producto ultracongelado a -18°C para preservar todo su sabor y textura artesanal. Llega a tu casa en perfecto estado, listo para que lo prepares cuando quieras. Sin conservantes artificiales.",
